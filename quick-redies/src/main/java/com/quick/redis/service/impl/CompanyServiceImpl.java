...
public class CompanyServiceImpl implements CompanyService {
    ...
    @Override
    public Integer addOne(String companyName) {
        try {
            Integer result = 0;
    ...
    public String delAll() {
        ...
        try {
            ...
            logger.error("delByKey" + e.getMessage());
            return "清空redis缓存失败！" + e.getMessage();
        }
    }
    ...
    public String delByKey(String key) {
        try {
            Object o = redisTemplate.opsForValue().get(key);
            if (o == null) {
                logger.error("根据key:" + key + "未查询到对应的value");
                return "根据key:" + key + "未查询到对应的value";
            }
    ...
    @Override
    public String saveCompany(String key,Company c) {
